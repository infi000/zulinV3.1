...
import "../index.scss";
import { getTeacherVerService, getTeacurstatusmodifyService, getTeaordercancleService, getTeaordercompleteService, getTeaorderconService, getTeaorderendService, getTeaorderlistService } from "../services";
...
const OrderEnd = (props: IProps) => {
  const { cancel, puid, oid } = props;
  ...
  const handleSubmit = () => {
    ...
    getTeaordercompleteService(params).then(res => {
      showSuccessToast("项目完结成功");
      cancel();
    })
